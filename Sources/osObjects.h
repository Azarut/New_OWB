...
*/
extern void BlinkThread (void const *argument);          // thread function

osThreadId tid_BlinkThread ;                              // thread id
osThreadDef (BlinkThread , osPriorityNormal, 1, 0);       // thread object
// global 'semaphores' ----------------------------------------------------------
/* 
Example:
